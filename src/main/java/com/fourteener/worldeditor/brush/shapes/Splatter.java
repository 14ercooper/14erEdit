...
import com.fourteener.worldeditor.blockiterator.iterators.MultiIterator;
...
public class Splatter extends BrushShape {
	...
	public BlockIterator GetBlocks(List<Double> args, double x, double y, double z) {
		try {
			...
			Main.logError("Could not parse splatter brush. Did you provide splatter radius, sphere count, sphere radius, and radius correction?", Operator.currentPlayer);
			return null;
		}
	}
