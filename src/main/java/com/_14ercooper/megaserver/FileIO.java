...
public class FileIO {
    ...
    // Zip a folder
    public static void zipDirectory(File directoryToCompress, File outputDirectory, String topFolderName,
	    String outFile) throws InterruptedException {
	try {
    ...
    private static void zipDirectoryHelper(File rootDirectory, File currentDirectory, ZipOutputStream out,
	    String topFolderName) throws Exception {
