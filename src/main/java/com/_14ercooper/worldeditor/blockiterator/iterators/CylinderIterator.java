...
public class CylinderIterator extends BlockIterator {
	...
	@Override
	public CylinderIterator newIterator(List<String> args) {
		try {
			...
			Main.logError("Error creating cylinder iterator. Please check your brush parameters.", Operator.currentPlayer);
			return null;
		}
	}
