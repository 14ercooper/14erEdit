...
public class SelectionManager {
	...
	positionOne[2] = z;
	player.sendMessage("§dFirst position updated to (" + Double.toString(x) + ", " + Double.toString(y) + ", "
		+ Double.toString(z) + "); giving a volume of "
	...
	positionTwo[2] = z;
	player.sendMessage("§dSecond position updated to (" + Double.toString(x) + ", " + Double.toString(y) + ", "
		+ Double.toString(z) + "); giving a volume of "
		+ Double.toString((Math.abs(positionOne[0] - positionTwo[0]) + 1)
			* (Math.abs(positionOne[1] - positionTwo[1]) + 1)
			* (Math.abs(positionOne[2] - positionTwo[2]) + 1)));
	...
	player.sendMessage("§dRegion expanded to " + Double.toString(Math
