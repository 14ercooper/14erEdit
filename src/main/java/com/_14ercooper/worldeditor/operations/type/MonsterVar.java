...
public class MonsterVar implements Serializable {
	...
	if (!(hand.isEmpty() && offhand.isEmpty())) {
		...
		s += Operator.itemVars.get(hand).asNBT();
	    if (offhand.isEmpty())
		s += ",{}";
	    else
		s += "," + Operator.itemVars.get(offhand).asNBT();
	    s += "],HandDropChances:[";
	...
	if (!(head.isEmpty() && chest.isEmpty() && legs.isEmpty() && feet.isEmpty())) {
		...
		s += "," + Operator.itemVars.get(feet).asNBT();
	    if (legs.isEmpty())
		s += ",{}";
	    else
		s += "," + Operator.itemVars.get(legs).asNBT();
	    if (chest.isEmpty())
		s += ",{}";
	    else
		s += "," + Operator.itemVars.get(chest).asNBT();
	    if (head.isEmpty())
		s += ",{}";
	    else
		s += "," + Operator.itemVars.get(head).asNBT();
	    s += "],ArmorDropChances:[";
