...
public class ArctangentNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public ArctangentNode newNode(ParserState parserState) {
        ArctangentNode node = new ArctangentNode();
    ...
    public double getValue(OperatorState state) {
        return Math.atan(a.getValue(state));
    }
