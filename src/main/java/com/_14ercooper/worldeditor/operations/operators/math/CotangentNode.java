...
public class CotangentNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public CotangentNode newNode(ParserState parserState) {
        CotangentNode node = new CotangentNode();
    ...
    public double getValue(OperatorState state) {
        return 1.0 / Math.tan(a.getValue(state));
    }
