...
public class CosecantNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public CosecantNode newNode(ParserState parserState) {
        CosecantNode node = new CosecantNode();
    ...
    public double getValue(OperatorState state) {
        return 1.0 / Math.sin(a.getValue(state));
    }
