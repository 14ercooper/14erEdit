...
public class Log10Node extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public Log10Node newNode(ParserState parserState) {
        Log10Node node = new Log10Node();
    ...
    public double getValue(OperatorState state) {
        return Math.log10(a.getValue(state));
    }
