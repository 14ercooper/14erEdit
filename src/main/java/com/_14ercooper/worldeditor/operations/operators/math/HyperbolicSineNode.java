...
public class HyperbolicSineNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public HyperbolicSineNode newNode(ParserState parserState) {
        HyperbolicSineNode node = new HyperbolicSineNode();
    ...
    public double getValue(OperatorState state) {
        return Math.sinh(a.getValue(state));
    }
