...
public class NaturalLogNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public NaturalLogNode newNode(ParserState parserState) {
        NaturalLogNode node = new NaturalLogNode();
    ...
    public double getValue(OperatorState state) {
        return Math.log(a.getValue(state)) / Math.log(Math.E);
    }
