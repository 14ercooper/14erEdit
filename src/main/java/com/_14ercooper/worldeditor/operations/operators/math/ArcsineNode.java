...
public class ArcsineNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public ArcsineNode newNode(ParserState parserState) {
        ArcsineNode node = new ArcsineNode();
    ...
    public double getValue(OperatorState state) {
        return Math.asin(a.getValue(state));
    }
