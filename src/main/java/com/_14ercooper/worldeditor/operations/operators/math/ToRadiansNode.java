...
public class ToRadiansNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public ToRadiansNode newNode(ParserState parserState) {
        ToRadiansNode node = new ToRadiansNode();
    ...
    public double getValue(OperatorState state) {
        return Math.toRadians(a.getValue(state));
    }
