...
public class ArccosineNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public ArccosineNode newNode(ParserState parserState) {
        ArccosineNode node = new ArccosineNode();
    ...
    public double getValue(OperatorState state) {
        return Math.acos(a.getValue(state));
    }
