...
public class HyperbolicCosineNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public HyperbolicCosineNode newNode(ParserState parserState) {
        HyperbolicCosineNode node = new HyperbolicCosineNode();
    ...
    public double getValue(OperatorState state) {
        return Math.cosh(a.getValue(state));
    }
