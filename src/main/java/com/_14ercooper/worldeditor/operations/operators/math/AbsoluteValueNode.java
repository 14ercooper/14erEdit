...
public class AbsoluteValueNode extends NumberNode {

    NumberNode a;

    // Returns a new node
    @Override
    public AbsoluteValueNode newNode(ParserState parserState) {
        AbsoluteValueNode node = new AbsoluteValueNode();
    ...
    public double getValue(OperatorState state) {
        return Math.abs(a.getValue(state));
    }
