...
public class ScriptSquareBrushReplace extends Craftscript {
	...
	public boolean perform(LinkedList<String> args, Player player, String label) {
		try {
			...
			return player.performCommand("fx br square " + brushRadius + " " + opToRun);
		} catch (Exception e) {
			Main.logError("Error creating brush. Did you pass in the correct parameters?", Operator.currentPlayer);
			return false;
		}
	}
}
